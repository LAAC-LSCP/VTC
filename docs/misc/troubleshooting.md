...
| Model weights missing / empty `VTC-2/` dir | `git lfs install && git submodule update --init --recursive`                   |
...
Open an issue on [GitHub](https://github.com/LAAC-LSCP/VTC/issues) including:

- your operating system,
- the Python version (`uv run python --version`),
